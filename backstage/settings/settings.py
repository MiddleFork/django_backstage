...
# PROJECT SETTINGS (name, path, etc.)
from backstage.settings.project_settings import *

TEMPLATE_DIRS = TEMPLATE_DIRS + PROJECT_TEMPLATE_DIRS
TEMPLATE_CONTEXT_PROCESSORS = PROJECT_TEMPLATE_CONTEXT_PROCESSORS + TEMPLATE_CONTEXT_PROCESSORS
